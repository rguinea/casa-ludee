...
const Information: React.FC = (): JSX.Element => {
  return <Container>
    <Text>
      ...
      <br/>
      <br/>
      Todo lo que encuentres en Casa Ludee esta  diseñado para hacerte sentir como en casa,  desde sus amplíos espacios y sus áreas verdes y abiertas hasta la comodidad de nuestras camas pensadas solo en tu descanso.
      <br/>
      <br/>
